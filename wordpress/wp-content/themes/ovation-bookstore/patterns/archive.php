...
/**
 * Title: Archives
 * Slug: ovation-bookstore/archive
 * Categories: ovation-bookstore, archive
 */
?>
...
<h3 class="wp-block-heading has-text-align-center has-heading-color has-text-color has-link-color"><?php esc_html_e('Sorry, no post exist...','ovation-bookstore'); ?></h3>
<!-- /wp:heading -->
